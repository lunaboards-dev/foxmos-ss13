...
ByondValue ByondValue::ReadVar(char const * key) {
	return Byond_ReadVar(value, key);
}

ByondValue ByondValue::ReadVarByStrId(u4c ref) {
	return Byond_ReadVarByStrId(value, ref);
}
