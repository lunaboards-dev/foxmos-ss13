...
void TurfGrid::refresh() {
	int new_maxx = GetWorld("maxx").data.num;//Value::World().get("maxx").valuef;
	int new_maxy = GetWorld("maxy").data.num;//Value::World().get("maxy").valuef;
	int new_maxz = GetWorld("maxz").data.num;//Value::World().get("maxz").valuef;
